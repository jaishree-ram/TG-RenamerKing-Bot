...
@pyrogram.Client.on_message(pyrogram.Filters.command(["help@Renamefiles28_bot"]))
...
@pyrogram.Client.on_message(pyrogram.Filters.command(["start@Renamefiles28_bot"]))
...
@pyrogram.Client.on_message(pyrogram.Filters.command(["about@Renamefiles28_bot"]))
