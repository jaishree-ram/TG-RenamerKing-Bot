...
@pyrogram.Client.on_message(pyrogram.Filters.command(["generatecustomthumbnail@Renamefiles28_bot"]))
...
@pyrogram.Client.on_message(pyrogram.Filters.command(["setthumbnail@Renamefiles28_bot"]))
